...
import cn.pk5454754.executor.CompileExecutor;
import cn.pk5454754.util.FilesUtil;
import cn.pk5454754.util.PatcherUtil;
import cn.pk5454754.util.PathResult;
...
public class ExportPatcherDialog extends JDialog {
    ...
    public ExportPatcherDialog(final AnActionEvent event) {
        ...
        if (module != null && config != null && config.getExportPathMap().containsKey(module.getName())) {
